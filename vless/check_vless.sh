...
output_yi_xiu() {
    ...
    echo -e " '----------------'  '----------------'  '----------------'  '----------------'  '----------------' ${NC}"
    echo -e "--------------------------------------------------------------------------------------------------"
    echo -e "YouTuBe: ${GREEN}https://www.youtube.com/@yixiu001${NC}"
...
generate_uuid() {
    ...
    # 预定义的UUID列表
    predefined_uuids=(
        "0b03f6c1-a2a1-4e13-d7f3-0722d969235d"
        "fec4f7ed-5fe7-6cd2-1382-eae506b32db4"
        "a01f2275-e6ec-2561-708d-b0486854d217"
        "625f0133-3144-3019-5561-f0cf8ba3742d"
        "23d000c5-a742-faba-19dc-4ec119eb2985"
        "bdb70933-3f2f-a61f-6b04-934dab56121f"
        "f2aa7f67-728f-e7a2-a606-ae94f6806207"
        "3dea3dfe-f301-552d-d9f4-6dd03aa8949c"
        "fd4d7d83-1fbc-5dc6-402d-a66052b751a0"
        "a0802e69-b7a1-133d-644e-d6e30f61aa1b"
    )
